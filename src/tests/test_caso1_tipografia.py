...
class TestCaso1Tipografia:
    ...
    @pytest.mark.parametrize("lista_in, lista_out", [
        ...
        ([r"Sant\`anna M. H.", "Sant'anna M. H."], ["Sant'anna M. H.", "Sant'anna M. H."]),
        ([r"D’Avila", r"D\`Avila", "D'Avila"], ["D'Avila", "D'Avila", "D'Avila"]),
        ([r"Sant’anna", "Sant`anna"], ["Sant'anna", "Sant'anna"]),
        ([r"Mônica Hirata Sant\`anna"], ["Mônica Hirata Sant'anna"]),
