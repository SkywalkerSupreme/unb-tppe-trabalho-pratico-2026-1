...
class TestCaso3Particulas:
    ...
    @pytest.mark.parametrize("lista_in, lista_out", [
        ...
        (["Yuri Vieira Faria", "Yuri de Vieira Faria"], ["Yuri de Vieira Faria", "Yuri de Vieira Faria"]),
        (["Raphael Gonçalves Viana", "Raphael Gonçalves de Viana"], ["Raphael Gonçalves de Viana", "Raphael Gonçalves de Viana"]),
