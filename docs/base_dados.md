...
## O Arquivo `dados_curadoria_800.json`
...
##  Amostragem de Casos Identificados na Base
Os dados contidos no JSON foram mapeados para servir de insumo (*fixtures*) nos testes parametrizados e garante que o algoritmo real da Etapa 2 precise varrer e limpar inconsistências massivas de forma automatizada.
